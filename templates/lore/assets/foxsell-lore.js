...
class LoreMixMatch extends FoxSellMixMatch {
...
class LoreFoxSellProductCard extends FoxSellProductCard {
...
class FoxSellProductModal extends HTMLElement {
  ...
  async renderProductModal(productId) {
    ...
    const sectionName = 'foxsell-lore-product-modal';
...
class LoreFoxSellProductModal extends FoxSellProductModal {
...
const elements = [
  ...
  ['foxsell-mix-match', LoreMixMatch],
  ['foxsell-category-header', FoxSellCategoryHeader],
  ['foxsell-product-card', LoreFoxSellProductCard],
  ...
  ['foxsell-product-modal', LoreFoxSellProductModal],
